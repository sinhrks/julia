...
precompile(Base.call, (Array{Any, 1}, Type{Base.LineEdit.Prompt}, UTF8String))
...
precompile(Base.convert, (Type{Union{UTF8String, UTF8String}}, UTF8String))
precompile(Base.LineEdit.keymap_fcn, (Function, Base.LineEdit.MIState, UTF8String))
